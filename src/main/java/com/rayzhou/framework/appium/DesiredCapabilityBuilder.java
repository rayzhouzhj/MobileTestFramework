...
//		iOSCapabilities.setCapability("bundleid", RunTimeContext.getInstance().getProperty("BUNDLE_ID"));
		
		if(TestingDevice.isRealDevice())
		{
		...
		// Use IOS_XCUI_TEST for OS system greater than 10.0
		String version = TestingDevice.getOSVersion();
